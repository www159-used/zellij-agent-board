...
Log lines that are noise in every World — a CliPipe one-second timeout, or
`Starting Zellij client!` after an intended switch — need no rule: only the
markers below can break a Hold.
"""
